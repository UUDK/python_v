...
python main.py --add-horse --race-name "Big Darby" --horse "Troudeau" --odds 2.6
python main.py --add-horse --race-name "Big Darby" --horse "Frederix" --odds 4.7
...
python main.py --add-bet --player-name "Jack Norman" --race-name "Big Darby" --horse "Xerxes" --amount 75
